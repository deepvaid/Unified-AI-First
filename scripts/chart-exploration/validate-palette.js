/**
 * Vendored from the Anthropic `dataviz` skill's scripts/validate_palette.js
 * (skill bundle 2.1.219) so the chart-exploration palette gates are runnable
 * from this repo forever. Local adaptations: deltaE / oklch / okhue exported
 * for the option-palette runner (validate-palettes.mjs). Thresholds unchanged.
 *
...
export const okhue = (h) => { const [, a, b] = oklab(h); return ((Math.atan2(b, a) * 180 / Math.PI) % 360 + 360) % 360; };
