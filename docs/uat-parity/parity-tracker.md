...
**Summary: 112 rows → 79 exists · 13 partial · 20 missing.** Build queue (all partial + missing rows) = 33; **6 built in A05 Marketing (2026-07-08)**, 27 remaining. Rows with `done` build status = 13 (7 earlier Marketing back-fills + 6 this slice).
