...
| 2 | Search ▸ Pinning | MerchandisingChannelSearchPinning | missing→built | done | 1fc7ae5 | Query pins: search + pin grid + pins table |
| 3 | Search ▸ Merchandising Rules | MerchandisingChannelSearchRules | partial→built | done | 1fc7ae5 | Rules exist collection-oriented; needs search-scoped rules list |
