...
| 2 | Chatbots | Chatbot | partial→built | done | e0a982d | "Customize your widget" builder (6 sections + live preview), replaces Tickets.vue reuse; useChatbot store; route fullPage |
