...
const seedChannels: SalesChannel[] = [
  {
    ...
    accountId: '2000290',
    name: 'Retest Sales Notification',
    type: 'web_store',
    status: 'connected',
    health: 'healthy',
    description: 'Primary web storefront for online commerce and merchandising.',
    connectedClouds: ['commerce', 'merchandise', 'store_builder'],
    createdAt: '2026-01-26T09:00:00Z',
    updatedAt: '2026-05-24T11:45:00Z',
    lastActivityAt: '2026-05-26T06:18:00Z',
    webStore: {
      domain: '2000290-165.uat.maropost.store',
