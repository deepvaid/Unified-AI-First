...
// Dashboard chart palette: a ?chart=blue|seaglass|harbor|electric|spectrum query param
...
const VALID_CHART_PALETTES: readonly ChartPalette[] = ['blue', 'seaglass', 'harbor', 'electric', 'spectrum']
