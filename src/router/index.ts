...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/accounts/:accountId/journeys/new', name: 'CreateJourney', component: () => import('@/views/Marketing/JourneySelection.vue'), meta: { builderShell: true } },
  { path: '/accounts/:accountId/journeys/new/scratch', name: 'CreateJourneyScratch', component: () => import('@/views/Marketing/CreateJourneyScratch.vue'), meta: { builderShell: true } },
  { path: '/accounts/:accountId/journeys/new/template', name: 'CreateJourneyFromTemplate', component: () => import('@/views/Marketing/JourneyTemplateWizard.vue'), meta: { builderShell: true } },
  // Production path (liquid-sky builder). The old sandbox path redirects so bookmarks keep working.
  { path: '/accounts/:accountId/journeys/:id/journey-builder', name: 'JourneyBuilder', component: () => import('@/views/Marketing/JourneyBuilder.vue'), meta: { builderShell: true } },
  { path: '/accounts/:accountId/journeys/:id/builder', redirect: to => ({ name: 'JourneyBuilder', params: to.params }) },
  ...
  { path: '/accounts/:accountId/footers/:id/preview', name: 'FooterPreview', component: () => import('@/views/Marketing/FooterPreview.vue') },
  { path: '/accounts/:accountId/image_groups', name: 'OptimizeOnOpen', component: () => import('@/views/Marketing/OptimizeOnOpen.vue') },
  { path: '/accounts/:accountId/image_groups/new', name: 'ImageGroupCreate', component: () => import('@/views/Marketing/ImageGroupEditor.vue') },
  { path: '/accounts/:accountId/image_groups/:id/edit', name: 'ImageGroupEdit', component: () => import('@/views/Marketing/ImageGroupEditor.vue') },
