...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/accounts/:accountId/campaign_tags/new', name: 'CreateCampaignTag', component: () => import('@/views/Marketing/CreateCampaignTag.vue'), meta: { fullPage: true } },
  ...
  { path: '/accounts/:accountId/surveys/new', name: 'CreateSurvey', component: () => import('@/views/Marketing/CreateSurvey.vue'), meta: { fullPage: true } },
