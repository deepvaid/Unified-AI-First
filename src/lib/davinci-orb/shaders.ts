// GLSL for the Da Vinci orb — ported verbatim from the Marojarvis prototype's
// orb.js (simulation, noise, membrane sampling and physics-driven displacement
// unchanged). The only changes: the fragment shaders' hardcoded ink/halo color
// literals became uniforms (uInkA/uInkB/uHalo) and the rainbow spectral shimmer
// became a brand 3-stop gradient (uGlowA/uGlowB/uGlowC ← --dv-orb-c1/2/3).
