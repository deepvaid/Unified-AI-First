...
//
// This is a heading, not a wrapper: it sits in the flow between fields and states
// its own rhythm, so adopting it is a one-line replacement rather than a re-nest of
// the whole region. The extra air a section needs over the ambient field gap is
// `field.sectionGap - field.groupGap`, expressed from tokens so it stays correct
// if either moves.
...
<template>
  <div class="mp-form-section">
    <component :is="`h${headingLevel}`" class="mp-form-section__title">
